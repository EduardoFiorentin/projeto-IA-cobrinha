...
class CobrinhaEnv(gym.Env):
    def __init__(self, render_mode=None):
        ...
        self.observation_space = spaces.Box(low=0, high=255, shape=(25, 25, 3), dtype=np.uint8)  # Redimensionado para 25x25
    ...
    def _get_state(self):
        ...
        resized_image = pygame.transform.smoothscale(pygame.surfarray.make_surface(raw_image), (25, 25))
